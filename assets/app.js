// Original inline scripts wrapped to run after partials load:
(function(){
  function runAll(){
  ...
  if (document.readyState === 'complete'){
    ...
    document.addEventListener('partials:loaded', runAll, { once:true });
    window.addEventListener('load', function(){ setTimeout(runAll, 0); }, { once:true });
  }
})();
